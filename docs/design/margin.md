      ...
      <form class="yonder-form form-inline" id="login">
        ...
        <div class="yonder-checkbox" id="remember">
          <div class="custom-control custom-checkbox">
            <input class="custom-control-input" type="checkbox" id="checkbox-311-680" name="remember" value="Remember me"/>
            <label class="custom-control-label" for="checkbox-311-680">Remember me</label>
            <div class="invalid-feedback"></div>
          </div>
        </div>
    ...
    output: |-
      <form class="yonder-form form-inline" id="login2">
        ...
        <div class="yonder-checkbox mr-sm-2 mb-2" id="remember">
          <div class="custom-control custom-checkbox">
            <input class="custom-control-input" type="checkbox" id="checkbox-91-719" name="remember" value="Remember me"/>
            <label class="custom-control-label" for="checkbox-91-719">Remember me</label>
            <div class="invalid-feedback"></div>
          </div>
        </div>
