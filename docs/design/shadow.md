...
- title: Styling a navbar
  ...
  - type: code
    ...
    output: "<div>\n  <nav class=\"navbar navbar-expand navbar-light bg-cyan shadow-sm
      ...
      type=\"button\" data-toggle=\"collapse\" data-target=\"#nav-content-31-794\"
      aria-controls=\"nav-content-31-794\" aria-expanded=\"false\" aria-label=\"Toggle
      navigation\">\n      <span class=\"navbar-toggler-icon\"></span>\n    </button>\n
      \   <div class=\"collapse navbar-collapse\" id=\"nav-content-31-794\"></div>\n
