          ...
          <div class="form-group">
            ...
            <div class="yonder-checkbox" id="deliver">
              <div class="custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" id="checkbox-336-604" data-value="Deliver"/>
                <label class="custom-control-label" for="checkbox-336-604">Deliver</label>
