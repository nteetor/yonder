    ...
    value: |-
      <div class="yonder-checkbox" id="potenti">
        <div class="custom-control custom-checkbox">
          <input class="custom-control-input" type="checkbox" id="checkbox-406-587" data-value="Suspendisse potenti" checked/>
          <label class="custom-control-label" for="checkbox-406-587">Suspendisse potenti</label>
