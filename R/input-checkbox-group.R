...
checkbox_group_option_list_item <-
  function(
    id,
    choice,
    value,
...
checkbox_group_option_attr_checked <-
  function(
    value,
    select
  ) {
...
checkbox_group_option_attr_disabled <-
  function(
    value,
    disable
  ) {
...
checkbox_group_option_class_appearance <-
  function(
    appearance
  ) {
    switch(
...
checkbox_group_option_class_layout <-
  function(
    layout
  ) {
    switch(
